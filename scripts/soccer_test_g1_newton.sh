...
MODEL_FILE="${MODEL_FILE:-$SCRIPT_DIR/MimicKit/output/soccer_g1_newton_phase1/model.pt}"
TEST_EPISODES="${TEST_EPISODES:-8}"
OUT_DIR="${OUT_DIR:-output/soccer_test_g1_newton}"
...
PYTHONUNBUFFERED=1 python -u mimickit/run.py --mode test \
  ...
  --agent_config data/agents/amp_task_g1_agent_phase1.yaml \
