...
RUN_PREFIX=output/soccer_g1_phase1
RESUME_ARGS=""
FRESH="${FRESH:-0}"
if [ "${FRESH}" = "1" ]; then
    LATEST_INT=""
...
python -u mimickit/run.py --mode train --num_envs 2048 --engine_config data/engines/isaac_lab_engine.yaml --env_config data/envs/amp_soccer_g1_env_phase1.yaml --agent_config data/agents/amp_task_g1_agent_phase1.yaml --visualize false --out_dir "${OUT_DIR}" --logger tb --save_int_models true ${RESUME_ARGS}
